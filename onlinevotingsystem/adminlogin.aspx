<%@ page language="C#" autoeventwireup="true" inherits="adminlogin, App_Web_ehcci40e" %>
...
<div id="tabs1" >
  ...
  <div id="dvbodycontainer">
    ...
    <div id="dvrightpanel">
      ...
      <td> <asp:TextBox ID="TextBox1" runat="server" Width="230px" OnTextChanged="TextBox1_TextChanged"></asp:TextBox></td>
      <td> 
